...
<%
  ...
  try
  {
    ...
    call = con.prepareCall( "{? = call pkg_acreditacion.lista_acreditados_entidad ( ? ) }" );
...
<% 
    ...
    {     
%>
<TD class=row2 ALIGN="Left" valign="TOP" ><FONT STYLE = "font-family:Tahoma; font-size:7pt; "><input type="submit" value="<%=rs.getString( 1 ) %>" name="ccodigo"></FONT></TD>
...
<h2><span class="maintitle">MODIFICAR DATOS</span></h2>
 ...
 <fieldset>
  ...
  <tr>
    ...
    <tr>
    <td class=row2 colspan="3">Código de la Persona Acreditada</td>
  </tr>
  <tr>
    <td class=row1 colspan="3"><html:text property="vcodigo" size="12" styleId="vcodigo"/></td>
  </tr>
  <tr>
