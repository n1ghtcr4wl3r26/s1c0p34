...
<html:hidden property="ctipomodif" value="1" /> 
...
<html:hidden property="vtipoobs" value="1" />
<html:hidden property="vtipolist"  />
<html:hidden property="vtipomodif" value="1" />
 <fieldset>
  ...
  <tr>
    <td class=row1 colspan="2">
        <html:text property="vcite" size="30" styleId="vcite" readonly="true" style="background-color:#FFC" /></td>
    <td class=row1 ><html:text property="vfeccite" size="10" styleId="vfeccite"  readonly="true" style="background-color:#FFC"/></td>
  </tr>
  ...
  <tr>
    <td colspan="3" ><html:text property="vnombre" size="50" styleId="vnombre" style="background-color:#FFC" readonly="true" onblur="this.value = this.value.toUpperCase()"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class=row2 colspan="3"> Fecha de Ascenso</td>
  </tr>
  <tr>
    <td class=row1 colspan="3">
  ...
  <tr>
    <td class=row2 colspan="3">CITE Solicitud de Ascenso</td>
  </tr>
  <tr>
