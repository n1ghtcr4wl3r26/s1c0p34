// Decompiled by DJ v3.5.5.77 Copyright 2003 Atanas Neshkov  Date: 18/12/2011 1:26:05
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   impacr2Action.java
...
public class impacr2Action extends Action
{

    public impacr2Action()
    {
    }
    ...
    {
        impacr2Form impf = (impacr2Form)request.getAttribute("impacr2Form");
        ...
        try
        {
            ...
            if(util.devuelve_estado_re(impf.getBotonimp()).equals("cancilleria")){
                ...
                {
                    reportName = "/jasper/REPATRI2.jasper";
                    imagenName = "/jasper/escudo_bolivia2.jpg";
                }
            }
            else{
                ...
                {
                    reportName = "/jasper/REPATRI2re.jasper";
                    imagenName = "/jasper/escudo_bolivia2.jpg";
                }                        
            }
